...
if(isset($_POST['submit']))
  ...
  $userid=$_SESSION['detsuid'];
    ...
    $query=mysqli_query($con, "insert into tblexpense(UserId,TranType,ExpenseDate,ExpenseItem,ExpenseCost) value('$userid','$trantype','$dateexpense','$item','$costitem')");
if($query){
...
<head>
	...
	<title>My-DayBook || Add Transaction</title>
