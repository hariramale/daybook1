	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Datewise Transactions Report</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Datewise Transactions Report</div>
...
?>
<h5 align="center" style="color:blue">Datewise Transactions Report from <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
